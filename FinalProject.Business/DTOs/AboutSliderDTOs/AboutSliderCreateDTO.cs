...
{
	public class AboutSliderCreateDTO
	{
...
public class AboutSliderCreateDTOValidator : AbstractValidator<AboutSliderCreateDTO>
{
	public AboutSliderCreateDTOValidator()
	{
		RuleFor(x => x.Title)
